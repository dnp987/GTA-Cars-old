     ...
     public void verify_quotes_menu() {
    	...
    	data_sheet_out.setCell(0, heading_data, "Arial", false, (short)10); // add the headings in row #0
    	 ...
    	 for (int i = startrow+1; i <= endrow; i++) {
    	     ...
    	     Select drpCountry = new Select(driver.findElement(By.cssSelector("div.paddingLeft25:nth-child(3) > select:nth-child(2)")));
    	     //drpCountry.selectByVisibleText("Canada");
    	     drpCountry.selectByVisibleText(testExchange);
	    	 ...
	    	 data_sheet_out.setCell(i, quote_data, "Verdana", false, (short)10);
    	 }
